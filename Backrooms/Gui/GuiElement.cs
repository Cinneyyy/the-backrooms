...
public abstract class GuiElement
{
    ...
    public GuiElement(string name, Vec2f location, Vec2f size, Vec2f? anchor = null)
    {
        ...
        Type type = GetType();
        Assert(Log.Info, type.Name.EndsWith("element", StringComparison.OrdinalIgnoreCase), $"All GUI element type names should end with the 'Element' suffix for clarity");
